# -*- coding: utf-8 -*-
"""
Created on Tue Jun 25 08:39:31 2019
...
data = pd.read_csv('drugabuse_detection.csv')

# Relacing special symbols and digits in headline column
# data['tweet'] = data['headline'].apply(lambda s : re.sub('[^a-zA-Z]', ' ', s))
